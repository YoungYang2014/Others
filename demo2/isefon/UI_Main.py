...
""))
        ...
        self.QToolButton_abnormite = QtGui.QToolButton(self.QFrame_MainMenu)
        self.QToolButton_abnormite.setObjectName(_fromUtf8("QToolButton_abnormite"))
        self.horizontalLayout_3.addWidget(self.QToolButton_abnormite)
        self.QToolButton_attshifts = QtGui.QToolButton(self.QFrame_MainMenu)
        self.QToolButton_attshifts.setObjectName(_fromUtf8("QToolButton_attshifts"))
        self.horizontalLayout_3.addWidget(self.QToolButton_attshifts)
...
""))
        ...
        spacerItem1 = QtGui.QSpacerItem(586, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.QLabeLogo.setText(_translate("MainWindow", " I am a logo", None))
        self.QToolButton_abnormite.setText(_translate("MainWindow", "考勤异常", None))
        self.QToolButton_attshifts.setText(_translate("MainWindow", "加班信息", None))
        self.QToolButton_Login.setText(_translate("MainWindow", "[登录]", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab1), _translate("MainWindow", "考勤信息", None))
        self.label_2.setText(_translate("MainWindow", "By 赵金龙", None))
